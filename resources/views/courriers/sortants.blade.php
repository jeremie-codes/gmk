...
@section('title', 'Courriers Sortants - ANADEC RH')
@section('page-title', 'Courriers Sortants')
@section('page-description', 'Gestion des courriers envoyés')
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <form method="GET" class="flex items-center space-x-2">
                    ...
                    @if(request()->hasAny(['search', 'statut', 'priorite']))
                        <a href="{{ route('courriers.sortants') }}" class="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-4 py-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('courriers.create') }}?type_courrier=sortant"
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-pink-50">
            <h3 class="text-lg font-medium text-gray-900 flex items-center">
                <i class="bx bx-log-out mr-2 text-purple-600"></i>
                Courriers Sortants
            </h3>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $courrier->date_envoi ? $courrier->date_envoi->format('d/m/Y') : '-' }}
                        </td>
