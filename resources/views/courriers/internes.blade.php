...
@section('title', 'Courriers Internes - ANADEC RH')
@section('page-title', 'Courriers Internes')
@section('page-description', 'Gestion des courriers internes')
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <form method="GET" class="flex items-center space-x-2">
                    ...
                    @if(request()->hasAny(['search', 'statut', 'priorite']))
                        <a href="{{ route('courriers.internes') }}" class="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-4 py-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('courriers.create') }}?type_courrier=interne"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">De / À</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">
                                <div><span class="font-medium">De :</span> {{ $courrier->expediteur }}</div>
                                <div><span class="font-medium">À :</span> {{ $courrier->destinataire }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $courrier->date_reception ? $courrier->date_reception->format('d/m/Y') : ($courrier->date_envoi ? $courrier->date_envoi->format('d/m/Y') : $courrier->created_at->format('d/m/Y')) }}
                        </td>
